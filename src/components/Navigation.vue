  ...
  <header class="px-4">
    <nav class="container mx-auto flex flex-col sm:flex-row justify-between items-center py-8">
      <div class="mb-4 sm:mb-0">
          <img v-if="theme === 'theme-light'" src="logos/logo.svg" alt="logo"> 
          <img v-else src="logos/logo-dark.svg" alt="logo">
      </div>
      <ul class="uppercase tracking-wide font-bold flex items-center space-x-8">
        <li>
          <a href="#" class="text-copy-primary hover:text-gray-500" @click.prevent="toggleTheme">
        ...
        <li>
          <router-link to="/" class="text-copy-primary hover:text-gray-500">
            Home
          </router-link>
        </li>
        <li>
          <router-link to="/projects" class="text-copy-primary hover:text-gray-500">
            Projects
          </router-link>
        </li>
        <li>
          <router-link to="/blog" class="text-copy-primary hover:text-gray-500">
            Blog
          </router-link>
        </li>
      </ul>
